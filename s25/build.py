...
def prep_schedule():
    ...
    schedule = [
        ...
        {"name": "Signal processing tasting menu I", "reading": [("Ruoe: use sinusoids", "https://venkatarun.wordpress.com/2022/04/18/why-the-sinusoid/"), ("Learn the rule to break it", "https://dl.acm.org/doi/pdf/10.1145/3230543.3230565")], "optional": []},
        {"name": "Signal processing tasting menu II", "reading": [], "optional": []},
