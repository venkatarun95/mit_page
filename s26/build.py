...
def prep_schedule():
    ...
    schedule = [
        ...
        {"name": "Congestion control III", "reading": [("Fair congestion control", "https://www.cs.utexas.edu/~venkatar/assets/papers/frcc.pdf")]},
        ...
        {"name": "Synthesis for Performance I", "reading": [("How broken are optimizers?", "https://www.usenix.org/system/files/nsdi24-namyar-finding.pdf")], "optional": []},
