...
def prep_schedule():
    dates = [
        ...
        date(2026, 3, 10),
        date(2026, 3, 12),
        # date(2025, 3, 17), # Spring break
        # date(2025, 3, 19), # Spring break
        date(2026, 3, 24),
        date(2026, 3, 26),
        date(2026, 3, 31),
        date(2026, 4, 2),
    ...
    schedule = [
        ...
        {"name": "Incorporating ML in systems I (Caching)", "reading": [("ML improves the average. Theory bounds the worst", "../sys_perf_analysis/competitive_caching_ml_advice.pdf")], "optional": []},
        {"name": "Incorporating ML in systems II", "reading": [("Cachine and ML (contd)", "../sys_perf_analysis/competitive_caching_ml_advice.pdf")]},
        ...
        {"name": "Incorporating ML in systems III", "reading": [("PolicySmith", "https://dl.acm.org/doi/pdf/10.1145/3772356.3772413"), ("Barbarians", "https://arxiv.org/pdf/2510.06189")]},
        {"name": "The use of statistics in systems", "reading": [("Google's test infrastructure", "https://dl.acm.org/doi/pdf/10.1145/1835804.1835810")]},
        # {"name": "Signal processing tasting menu II", "reading": [("Fundamental Limits (read before 7.1.1 and skim the rest)", "https://ethz.ch/content/dam/ethz/special-interest/itet/photonics-dam/documents/lectures/EandM/AngularSpectrumRepresentation.pdf"), ("Use the limits", "https://www.usenix.org/system/files/nsdi20-paper-arun.pdf")], "optional": []},
        ...
        {"name": "Congestion control II", "reading": [("BBR simplified description", "https://queue.acm.org/detail.cfm?id=3022184"), ("BBR detailed description", "https://datatracker.ietf.org/doc/draft-ietf-ccwg-bbr/?utm_source=chatgpt.com")], "optional": []},
        {"name": "Congestion control III/Performance Verifiaction I", "reading": [("Everything is broken", "https://dl.acm.org/doi/pdf/10.1145/3452296.3472912"), ("Everything is unfair", "https://dl.acm.org/doi/pdf/10.1145/3544216.3544223")], "optional": []},
        ...
        {"name": "Synthesis for Performance", "reading": [], "optional": []},
