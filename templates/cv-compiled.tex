...
{\bf Contact: } {\tt venkat@utexas.edu} \hfill {\bf Webpage:} \href{https://www.cs.utexas.edu/~venkatar/}{cs.utexas.edu/~venkatar}\\
...
\begin{itemize}[noitemsep,nolistsep]
        \item {\it On the Role of LLMs in Designing the Architecture of Networked Systems}\label{paper:archie_nsdi}\\
      Pratyush Sahu, Rahul Bothra, Venkat Arun, Brighten Godfrey, Akshay Narayan, Ahmed Saeed\\
      NSDI 2027\\
              \item {\it LFS: Learning-Based Flexible CPU Scheduler}\label{paper:lfs}\\
      Yeonju Ro, Vincent Zhang, Venkat Arun, Daehyeok Kim, Jiaxin Lin, Christopher J. Rossbach, Atlas Wang, Aditya Akella\\
      NSDI 2027\\
      ...
      NSDI 2026\\
              \item {\it Contracts: A unified lens on congestion control robustness, fairness, congestion, and generality}\label{paper:contracts}\\
      Anup Agarwal, Venkat Arun, Srinivasan Seshan\\
      NINeS 2026\\
              \item {\it TierSizer: Counterfactual Reasoning for DRAM Sizing in Tiered Memory Systems}\label{paper:tiersizer}\\
      Sujay Yadalam, Saarth Deshpande, Divyanshu Saxena, Venkat Arun, Neeraja Yadwadkar, Aditya Akella\\
      DIMES 2026\\
              \item {\it Assistants, Not Architects: The Role of LLMs in Networked Systems Design}\label{paper:archie_full}\\
      Pratyush Sahu, Rahul Bothra, Venkat Arun, Brighten Godfrey, Akshay Narayan, Ahmed Saeed\\
      arXiv 2026\\
              \item {\it Bring Your Own Objective: Inter-operability of Network Objectives in Datacenters}\label{paper:byoo}\\
      Sanjoli Narang, Anup Agarwal, Venkat Arun, Manya Ghobadi\\
      arXiv 2026\\
              \item {\it Faster-than-light coordination for networked systems with quantum non-local games}\label{paper:nonlocal}\\
      Venkat Arun, Vijay Chidambaram, Scott Aaronson\\
      HotNets 2025\\
              \item {\it Robust Heuristic Algorithm Design with LLMs}\label{paper:robusta}\\
      ...
      NSDI 2024\\
              \item {\it A Performance Verification Methodology for Resource Allocation Heuristics}\label{paper:perf_verif}\\
